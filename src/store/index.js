            ...
            return new Promise((resolve) => {
                setTimeout(() => {
                    resolve([{
                        ...
                        "description": "Haier HEC R1 — телевизор с 43-дюймовым экраном, разрешение которого составляет 1920 х 1080 пикселей, и поддержкой Smart TV.",
                        "link": "https://img.mvideo.ru/Big/10030696bb.jpg",
                        "price": 3000
                    }, {
                        "id": 4,
                        "nameProduct": "Наушники",
                        "description": "Наушники True Wireless Huawei FreeBuds SE T0010 работают в частотном диапазоне от 20 Гц до 20 кГц, подключаются к смартфонам через Bluetooth-соединение",
                        "link": "https://www.hdretail.ru/upload/iblock/bb6/bb66c6b50b4dd9369dfacf310df85bc6.jpg",
                        "price": 3300
                    }, {
                        "id": 5,
                        "nameProduct": "Вентилятор",
                        "description": "Напольный вентилятор Midea MVFS4003 спасет от жары даже в большом помещении. Модель сделана в лаконичном дизайне, поэтому впишется в любой интерьер.",
